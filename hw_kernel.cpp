...
#define U1_STRIDE 1
#define U1_K 3
#define U1_OUT_NUM_T 128
#define U1_IN_IMG_W 386
#define U1_IN_IMG_H 386
#define U1_IN_NUM_T 128
...
#define U1_ROW_IL_FACTOR 65
#define U1_COL_IL_FACTOR 8
#define U1_SA_ROWS 8
#define U1_SA_COLS 8
#define U1_LOCAL_REG_NUM 2048
#define U1_LOCAL_ACCUM_NUM 1024
...
#define U1_DATA0_BUF_SIZE 107520
#define U1_DATA0_HEAD_BUF_SIZE 6720000
#define U1_DATA1_BUF_SIZE 103680
#define U1_DATA1_HEAD_BUF_SIZE 8294400
#define U1_DATA2_BUF_SIZE 81920
#define U1_DATA2_HEAD_BUF_SIZE 6553600
...
#pragma HLS DATA_PACK variable=fifo_transfer_out0
  ...
  // loader buffer
  static ap_uint<U1_DATA0_WIDTH * U1_DATA0_FC_SIMD_FACTOR> cin_buf[U1_IN_NUM_T * U1_IN_IMG_H_T * U1_IN_IMG_W_T / U1_DATA0_FC_SIMD_FACTOR];
...
#pragma HLS DATA_PACK variable=fifo_transfer_out0
  ...
  // loader buffer
  static ap_uint<U1_DATA1_WIDTH * U1_DATA1_FC_SIMD_FACTOR> weight_buf[U1_IN_NUM_T * U1_OUT_NUM_T * U1_K * U1_K / U1_DATA1_FC_SIMD_FACTOR];
...
#pragma HLS INLINE off
  ...
  static U1_Data0TransferChannelType ping_buffer[U1_DATA0_FC_GROUP_FACTOR][U1_DATA0_BUF_SIZE / U1_DATA0_FC_SIMD_FACTOR];
  static U1_Data0TransferChannelType pong_buffer[U1_DATA0_FC_GROUP_FACTOR][U1_DATA0_BUF_SIZE / U1_DATA0_FC_SIMD_FACTOR];
...
static data_t0 cin_local[IN_H_T + K_T - 1][IN_W_T + K_T - 1][IN_NUM_T];
#pragma HLS ARRAY_PARTITIOn variable=cin_local dim=3 cyclic factor=8  
static data_t1 weight_local[OUT_NUM_T][K_T][K_T][IN_NUM_T];
#pragma HLS ARRAY_PARTITION variable=weight_local dim=4 cyclic factor=8
static data_t0 cout_local[OUT_H_T][OUT_W_T][OUT_NUM_T];
...
void cout_write(
	...
	static bus_t0 cout_burst_buf_ping[OUT_H_T * OUT_W_T * OUT_NUM_T * 3 / 2 / BUS_PACK_FACTOR0];
	static bus_t0 cout_burst_buf_pong[OUT_H_T * OUT_W_T * OUT_NUM_T * 3 / 2 / BUS_PACK_FACTOR0];
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
      ...
      cout<<"-------------running layer "<<layer_id+1<<"-------------"<<start_layer<<" "<<end_layer<<endl;
